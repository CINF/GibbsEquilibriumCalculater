...
if __name__ == '__main__':
    ...
    mol_1 = km.H2
    T=float('Nan')
    print'H2 entropy at unknown temp: ' + str(mol_1.entropy())
    print ''
    print'H2 entropy at 298.15K: ' + str(mol_1.entropy(298.15))

    print ''
    print'H2 enthalpy at unknown temp: ' + str(mol_1.enthalpy())
    print ''
    print'H2 enthalpy at 298.15K: ' + str(mol_1.enthalpy(298.15))

    print ''
    print'H2 gibbs at unknown temp: ' + str(mol_1.gibbs())
    print ''
    print'H2 gibbs at 298.15K: ' + str(mol_1.gibbs(298.15))
